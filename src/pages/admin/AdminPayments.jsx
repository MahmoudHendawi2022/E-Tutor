  ...
  return (
    <main className="admin-page">
      <AdminPageHeader
        ...
        title="Payments"
        description="Payment state, held funds, refunds, commission snapshots and tutor payout eligibility."
      />
      <AdminToolbar
        search={search}
        onSearch={(e) => setSearch(e.target.value)}
        placeholder="Search payment, booking, student or tutor..."
      >
      ...
      <div className="admin-table-wrap"><table className="admin-table"><thead><tr><th>Payment</th><th>Booking</th><th>Student</th><th>Tutor</th><th>Gross</th><th>Refund</th><th>Platform fee</th><th>Tutor earning</th><th>Payment</th><th>Funds</th><th>Payout</th><th>Created</th><th>Actions</th></tr></thead><tbody>
        {rows.map((payment) => {
          ...
          return <tr key={payment.id}>
            ...
            <td><AdminStatusBadge status={payment.paymentStatus} /></td><td><AdminStatusBadge status={payment.fundStatus} /></td><td><AdminStatusBadge status={payment.payoutStatus} /></td><td>{formatDateTime(payment.createdAt)}</td>
